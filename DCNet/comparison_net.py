...
if __name__ == '__main__':
    ...
    # model = SwinTransNet(n_classes=1, in_channels=29, is_deconv=True, is_batchnorm=True)
    # out = model(x, [201, 301])
    # print("out: ", out.size())
