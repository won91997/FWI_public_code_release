...
class DDNet70Model(nn.Module):
    ...
    def forward(self, inputs, _ = None):
        ...
        dc1_capture = F.interpolate(dc1_up2, size=self.output_size, mode='bilinear', align_corners=False)
        ...
        dc2_capture = F.interpolate(dc2_up2, size=self.output_size, mode='bilinear', align_corners=False)
