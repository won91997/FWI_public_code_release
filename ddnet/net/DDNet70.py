...
class DDNet70Model(nn.Module):
    def __init__(self, n_classes, in_channels, is_deconv, is_batchnorm, output_size=(256, 256), **kwargs):
        ...
        :param is_deconv:    Whether to use deconvolution
        :param is_batchnorm: Whether to use BN
        :param output_size:  Target output spatial size (H, W)
        '''
        ...
        self.dc1_up5 = unetUp(512, 256, output_lim=lim8, is_deconv=self.is_deconv)
        self.dc1_up4 = unetUp(256, 128, output_lim=lim4, is_deconv=self.is_deconv)
        self.dc1_up3 = netUp(128, 64, output_lim=lim2, is_deconv=self.is_deconv)
        self.dc1_up2 = netUp(64, 32, output_lim=lim1, is_deconv=self.is_deconv)

        self.dc2_up5 = unetUp(512, 256, output_lim=lim8, is_deconv=self.is_deconv)
        self.dc2_up4 = unetUp(256, 128, output_lim=lim4, is_deconv=self.is_deconv)
        self.dc2_up3 = netUp(128, 64, output_lim=lim2, is_deconv=self.is_deconv)
        self.dc2_up2 = netUp(64, 32, output_lim=lim1, is_deconv=self.is_deconv)
...
class SDNet70Model(nn.Module):
    def __init__(self, n_classes, in_channels, is_deconv, is_batchnorm, output_size=(256, 256), **kwargs):
        ...
        self.up5 = unetUp(512, 256, output_lim=[oh // 8, ow // 8], is_deconv=self.is_deconv)
        self.up4 = unetUp(256, 128, output_lim=[oh // 4, ow // 4], is_deconv=self.is_deconv)
        self.up3 = netUp(128, 64, output_lim=[oh // 2, ow // 2], is_deconv=self.is_deconv)
        self.up2 = netUp(64, 32, output_lim=[oh, ow], is_deconv=self.is_deconv)
