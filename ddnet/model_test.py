...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ddnet model test")
    parser.add_argument("--batch-of-single", type=int, default=1, help="1=batch test, 0=single test")
    parser.add_argument("--model-type", type=str, default="DDNet", help="DDNet|DDNet70|InversionNet|FCNVMB|SDNet|SDNet70")
    parser.add_argument("--model-path", type=str, default="...", help="checkpoint path")
    ...
    if batch_of_single == 1:
        ...
        if dataset_name in ["SEGSalt", "SEGSimulation"]:
            ...
            # [1~2, 0~499]
            select_id = [11, 104]
        single_test(args.model_path, select_id=select_id, model_type=model_type)
